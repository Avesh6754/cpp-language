...
//Create two overloaded member functions called print( ): one that takes no arguments and 
//simply prints the message stored in the variable and one that takes a string argument, 
...
{
	string msg,newmsg;
	cout<<"entre the first message : ";
	getline(cin,msg);	
	cout<<"entre the second message : ";
	getline(cin,newmsg);
